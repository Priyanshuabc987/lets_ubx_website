    ...
    <Draggable key={item.id} draggableId={item.id} index={index}>
      {(provided, snapshot) => (
        <div
          ...
          `}
        >
          <div className={`relative w-full rounded-lg overflow-hidden border-2 transition-all ${snapshot.isDragging ? 'border-primary shadow-2xl scale-105 z-50' : 'border-transparent'
            } ${
